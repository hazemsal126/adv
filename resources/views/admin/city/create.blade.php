                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>إضافة مدينة</div>
                        </div>
                            ...
                            <form action="{{route('city.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('name', null, array('placeholder' => 'اسم المدينة','class' => 'form-control input-circle')) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{route('city.index',['id'=>$id])}}" class="btn btn-circle grey-salsa btn-outline">الغاء</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
