                            ...
                            <form action="{{route('users.update',$user->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                        {!! Form::select('roles[]', $roles,$userRole, array('class' => 'form-control input-circle','multiple')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value=0 @if($user->isadmin == 0) selected @endif>لا</option>
                                <option value=1 @if($user->isadmin == 1) selected @endif>نعم</option>
                                </select>
                                        </div>
