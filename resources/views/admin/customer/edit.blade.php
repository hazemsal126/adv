                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="{{route('customer.update',$customer->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                        {!! Form::text('name', $customer->name, array('placeholder' => 'Name','class' => 'form-control input-circle')) !!}                                        </div>
                                    </div>
                                    <div class="form-group">
