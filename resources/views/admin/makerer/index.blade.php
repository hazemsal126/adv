...
@section('content')
    ...
    <div class="page-content">
        @include('admin.layout.breadcrumb',['title' => ' لوحة صناع المحتوى'])
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject bold uppercase"> لوحة صناع المحتوى</span>
                        </div>
                        <div class="tools">
                            @include('admin.include.add-btn',['route'=> route('makerer.create')])
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{route('makerer.index')}}" method="get" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-2">
                                        {!! Form::select('active',['غير نشط','نشط'],request('active'), array('placeholder' => 'نشط \ غير نشط','class' => 'form-control')) !!}
                                    </div>
                                    <div class="col-lg-2">
                            ...
                            @foreach($items as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('makerer.edit',$item->id) }}" class="btn btn-warning btn-flat btn-xs">تعديل</a>
                                        @endcan
                                            @can('makerer-destroy')
                                        ...
                                        <a class="btn btn-success btn-flat btn-xs" data-toggle="modal" data-target="#confirm-order{{$item->id}}" >الغاء التفعيل</a>
                                            @endcan

                                            @can('makerer-edit')

                                        <a class="btn btn-info btn-flat btn-xs" data-toggle="modal" data-target="#confirm-active{{$item->id}}" >تغير الحالة</a>
                                            @endcan
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                {!! Form::open(['method' => 'DELETE','route' => ['makerer.destroy', $item->id],'style'=>'display:inline']) !!}
                                ...
                                <div id="confirm-order{{$item->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p> هل تريد بالتأكيد الغاء التفعيل كصانع محتوى </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">الغاء</button>
                                ...
                                <div id="confirm-active{{$item->id}}" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                <h4 class="modal-title">تغير الحالة</h4>
                                            </div>
                                            <div class="modal-body">
                                                <p> هل تريد بالتأكيد تغير حالة صانع المحتوى </p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">الغاء</button>
                                                {!! Form::open(['method' => 'post','route' => ['makerer.active', $item->id],'style'=>'display:inline']) !!}
                                                {!! Form::submit('نعم', ['class' => 'btn btn-danger']) !!}
                                                {!! Form::close() !!}
                                            </div>
                                        </div>
