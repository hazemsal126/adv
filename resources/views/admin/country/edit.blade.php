                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>تعديل بيانات الدولة</div>
                        </div>


                        <div class="portlet-body form">
                            <form action="{{route('country.update',$item->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('name', $item->name, array('placeholder' => 'اسم الدولة','class' => 'form-control input-circle')) !!}
                                        </div>
                                    </div>
