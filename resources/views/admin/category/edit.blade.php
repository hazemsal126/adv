                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <form action="{{route('category.update',$item->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{route('category.index')}}" class="btn btn-circle grey-salsa btn-outline">الغاء</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
