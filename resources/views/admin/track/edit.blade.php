                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>تعديل مقطع</div>
                        </div>


                        <div class="portlet-body form">
                            <form action="{{route('track.update',$item->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                    ...
                                    <div class="tab-pane active" id="ar">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    {!! Form::select('album_id',$albums,$item->album_id, array('placeholder' => 'اختر الألبوم','class' => 'form-control')) !!}
