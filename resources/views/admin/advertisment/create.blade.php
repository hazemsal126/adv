                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>إضافة اعلان</div>
                        </div>


                        <div class="portlet-body form">
                            <form action="{{route('advertisment.store')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('title', null, array('placeholder' => 'عنوان المنتج','class' => 'form-control input-circle')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">سعر المنتج</label>
                                        <div class="col-md-6">
                                            {!! Form::number('price', null, array('placeholder' => 'سعر المنتج','class' => 'form-control input-circle')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::select('cat_id', $cats,null, array('placeholder' => 'اختر القسم','class' => 'form-control input-circle','id' => 'cat_id')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::select('country_id', $countries,null, array('placeholder' => 'اختر الدولة','class' => 'form-control input-circle','id' => 'country_id')) !!}
                                        </div>
                                    </div>
