                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>إضافة ألبوم</div>
                        </div>


                        <div class="portlet-body form">
                            <form action="{{route('album.update',$item->id)}}" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                    ...
                                    <div class="tab-pane active" id="ar">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    {!! Form::text('title',  $item->title , array('placeholder' => 'العنوان','class' => 'form-control input-circle')) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">وصف الألبوم  </label>
                                                <div class="col-md-6">
                                                    {!! Form::textarea('desc',   $item->desc  , array('id'=>'desc','class' => 'form-control input-circle')) !!}
                                                </div>
                                            </div>

                                            <div class="form-group last">
                                                <label class="control-label col-md-3">صورة الألبوم</label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select id="multiple" name="cat[]" class="form-control select2-multiple cat_mutiple" multiple>
                                                        @foreach ($cats as $cat)
                                                                <option value="{{ $cat->id }}" @if($item->cats->where('cat_id',$cat->id)->first()) selected @endif>{{ $cat->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select id="multiple" name="subcat[]" class="form-control select2-multiple subcat_muliple" multiple>
                                                        ...
                                                        <option value="{{ $sub->id }}" @if($item->subcats->where('sub_cat_id',$sub->id)->first()) selected @endif>{{ $sub->name }}</option>
                                                        @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <select id="multiple" name="artist[]" class="form-control select2-multiple" multiple>
                                                       @foreach ($artists as $artist)
                                                            <option value="{{ $artist->id }}" @if($item->artists->where('artist_id',$artist->id)->first()) selected @endif>{{ $artist->username }}</option>
                                                       @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">المقاطع</label>

                                                    <div class="col-md-6">
                                                    <input type="file" name="video[]" accept="video/*,audio/*" multiple />
                                                    </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="en">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    {!! Form::text('title_en', $item->title_en, array('placeholder' => 'Title en','class' => 'form-control input-circle')) !!}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::textarea('desc_en',  $item->desc_en, array('id'=>'desc_en','class' => 'form-control input-circle')) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{route('album.index')}}" class="btn btn-circle grey-salsa btn-outline">الغاء</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
